 ...
 * Time: 22:18
 */
public class GetTransitionForInitialStatus extends BaseQuestionStatusAction {
    ...
    protected String executeImpl() throws Exception {
        transitions = statusService.findTransitionalStates(statusService.findStartStatus());
        return null;
    }
