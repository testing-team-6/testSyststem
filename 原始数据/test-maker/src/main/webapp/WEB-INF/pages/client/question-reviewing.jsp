...
<div class="container-fluid">
    ...
    <div id="q-workspace-container" class="row">
        ...
        <table id="q-review-table" class="table table-striped table-bordered table-responsive table-condensed">
        </table>
    </div>
...
<script src="${ctx}/assets/js/client/question-reviewing/question-reviewing.js"></script>
